...
class BedrockTool:
    ...
    def generate_sql(self, question: str) -> dict:
        ...
        system_prompt = (
            "You are a PostgreSQL expert. Write a single safe SELECT query for the question below.\n"
            "Table: public.fusion_time_entries\n"
            "Columns:\n"
            ...
            "Rules:\n"
            "  1. ONLY write SELECT statements — never INSERT, UPDATE, DELETE, DROP, ALTER, or TRUNCATE.\n"
            "  2. Always use public.fusion_time_entries as the table name.\n"
            "  3. Limit results to 200 rows using LIMIT 200.\n"
            "  4. Return ONLY the raw SQL — no markdown, no explanation, no backticks.\n"
            "  5. If the question cannot be answered from this table, respond with exactly: CANNOT_ANSWER"
        )
